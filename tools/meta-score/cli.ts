...
function parseArgs(argv: string[]): MetaScoreInput {
  ...
  return {
    ...
    problemClass: input["problem-class"] ?? input["problemClass"],
    ...
    problemHooks: input["problem-hooks"] ?? input["problemHooks"],
    strategyHooks: input["strategy-hooks"] ?? input["strategyHooks"],
